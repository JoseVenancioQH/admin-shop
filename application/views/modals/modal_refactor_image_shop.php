  ...
  <form id="form-usersegmentation" method="POST" autocomplete="false">
    ...
    <div class="input-group form-group" style="display: inline-block;">
      ...
      <span class="input-group-addon">
          <input type="radio" name="active" id="user-enabled" class="minimal" checked='checked'>
      <label for="enabled">Enabled</label>
        </span>
        <span class="input-group-addon">
          <input type="radio" name="active"  id="user-disabled" class="minimal"> 
      <label for="disabled">Disabled</label>
        </span>
      <input type="hidden" name="group_id" class="minimal" >
