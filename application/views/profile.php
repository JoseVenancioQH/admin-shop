  ...
  <div class="col-md-9">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li><a href="#password" data-toggle="tab">Config Password</a></li>
      </ul>
      <div class="tab-content">
        ...
        <div class="tab-pane" id="password">
          <form class="form-horizontal" action="<?php echo base_url('Profile/ubah_password') ?>" method="POST">
            <div class="form-group">
              <label for="passLama" class="col-sm-2 control-label">Password Current</label>
              <div class="col-sm-10">
                <input type="password" class="form-control" placeholder="Password Current" name="passLama">
              </div>
            </div>
            <div class="form-group">
              <label for="passBaru" class="col-sm-2 control-label">Password New</label>
              <div class="col-sm-10">
                <input type="password" class="form-control" placeholder="Password New" name="passBaru">
              </div>
            </div>
            <div class="form-group">
