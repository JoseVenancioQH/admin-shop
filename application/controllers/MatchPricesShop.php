...
class MatchPricesShop extends AUTH_Controller {
	...
	public function index() {
		...
		file_put_contents("marcas.json",json_encode($data['marcas']));
	
		$data['page'] 		= "Match Prices Shop";
		$data['titulo'] 		= "Data Match Prices Shop";
		$data['descripcion'] 	= "Manage Data Match Prices Shop";

		$data['modal_image'] = show_my_modal('modals/modal_image', 'modalimage', $data);

		$this->template->views('matchpricesshop/home', $data);
	}	
